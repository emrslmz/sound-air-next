<template>
  <div>
    <div class="py-20 pb-36 bg-black flex flex-col items-center justify-center">
      ...
      <div class="pb-10">
        <h1 class="text-5xl font-extrabold leading-10 tracking-tight text-left text-white md:text-center sm:leading-none md:text-6xl lg:text-5xl">
          ...
          <span class="relative py-3 text-transparent bg-clip-text bg-gradient-to-br from-indigo-600 to-indigo-500 md:inline-block"> senin için hazırladığımız temaları dene!</span> <span> 🤩</span>
        </h1>
      </div>
