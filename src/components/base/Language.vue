    ...
    <div class="flex justify-center">
      ...
      <div class="flex items-center gap-2 rounded-lg bg-indigo-500 p-2">
        <div class="text-white py-0.5">
          <p :class="!language ? 'opacity-100' : 'opacity-25'"><img width="20" height="20" src="@/assets/images/icon/flag-united-kingdom_1f1ec-1f1e7.png" alt="tr-flag" /></p>
        </div>
        ...
        <div class="text-white py-0.5">
          <p :class="language ? 'opacity-100' : 'opacity-50'"><img width="20" height="20" src="@/assets/images/icon/flag-turkey_1f1f9-1f1f7.png" alt="tr-flag" /></p>
        </div>
      </div>
    </div>
  </div>
