      ...
      <div class="max-w-2xl mx-auto text-white py-10">
        <div class="text-center">
          ...
          <div class="flex justify-center my-10">
            <div class="flex items-center border w-auto rounded-lg px-4 py-2 w-52 mx-2 relative">
            ...
            <div class="flex items-center border w-auto rounded-lg px-4 py-2 w-44 mx-2 relative">
